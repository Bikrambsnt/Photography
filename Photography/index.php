...
<body>
    <div class="main" id="home">
        ...
        <nav>
            ...
            <a href="#upload" id="uploadBtn">Upload</a>
            <a href="#contact">Contact</a>
        </nav>

      <div class="search-container custom-search-container">
            <input type="text" id="searchInput" placeholder="" onkeyup="handleSearch(event)">
            <span class="search-icon" onclick="searchFunction()">&#128269;</span>
        </div>
        <div class="title">
            <p class="main-title">Photography
            </p>
        </div>
        <div class="slogan">
        ...
        <div class="social">
            <div class="fb-icon">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256"
                    ...
                    <g fill="#d7a610" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
...
<div class="sign-in">
    <h2>Sign In</h2>
    <form id="signInForm" action="login.php" method="post" onsubmit="return validateFormSignIn()">
        ...
        <button type="submit" id="submit" name="submit">Login In</button>
    </form>
    <p>Don't have an account?
        <span class="switch" onclick="flipCard()"> Sign Up
        </span>
    </p>
</div>
...
<div class="sign-up">
    <h2>Sign Up</h2>
    <form id="signUpForm" action="register.php" method="post" onsubmit="return validateFormSignUp()">
        <div class="form-group">
    ...
    <p>Already have an account?
        <span class="switch" onclick="flipCard()"> Sign In</span>
    </p>
</div>
  ...
  <!--Login form End-->
    ...
    <section class="About" id="about">
        ...
        <p class="intro">
            Hey photographers! Welcome to Foto. it,s not your usual photo-sharing spot,<br>
            but your go-to place for all things pictures. Let me break it down for you!
        </p>
        <div class="card-a">
            <span>
            <p class="top-a">
                Easy-Peasy Photo Uploading
                <p class="phrase">Keeping things simple! Have some cool photos to share? No problem, just log in quickly, and you're good to go. No need for complicated tech stuff, just your pictures taking center stage. It's like sharing with friends without any hassle – the way we like it! So, why wait? Jump in, display your top snaps, and let the good times begin</p>
            </p>
        </span>
        </div>
        <div class="card-b">
            <span>
            <p class="top-b">
                Your Own Personal Showcase
            </p>
            <p class="phrase-a">
                Witness the magic as your photographs take center stage on our Gallery page. It's akin to having your very own online exhibition, minus the velvet ropes. Your shots, each telling a unique story, proudly displayed for everyone to appreciate and immerse themselves in
            </p>
            </span>
        ...
        <div class="card-c">
            <span>
                ...
                <p class="phrase-b">
                    More than just pixels, our community thrives on the connections between people. Dive headfirst into the vibrant community vibes, explore the captivating snapshots others are sharing, and forge meaningful connections with like-minded camera enthusiasts. Because here, we're not just individuals; we're a collective, and we're all in this together!
                </p>
            </span>
        </div>
        <div class="card-d">
            <span>
                <p class="top-d">
                    Grab & Share the Good Stuff
                </p>
                <p class="phrase-c">
                    Ever stumbled upon a photo so breathtaking it made your jaw drop? Don't just appreciate it – grab it, download it, and spread the love among your crew. After all, great photos are meant to be enjoyed, and sharing is the purest form of caring, right? Embrace the joy of sharing exceptional visual experiences with those around you.
                </p>
...
<span>
    ...
    <p class="phrase-d">
        Feel the urge to be the arbiter of photographic brilliance? Take the reins and rate your favorite pics. Your constructive feedback has the power to be the boost someone needs to elevate their photo game. Let's keep the conversation alive, appreciating and celebrating the artistry that each photograph brings to the table.
    </p>
</span>
        </div>
        <div class="card-f">
            <span>
                ...
                <p class="phrase-e">
                    We understand the importance of privacy. Rest easy, knowing that your personal space is securely locked down at [Your Name]'s Photo Hub. This is your sanctuary, where you call the shots, ensuring that your photographic journey remains a safe and secure experience.
                </p>
            </span>
        </div>
       <p class="phrase-f">
        Whether you're a seasoned pro or just getting started,Foto is the place to be. <br>
        Ready to share your moments and make some memories?<br>
         Log-in, drop those pics, and let's make this Foto a lively spot together!
       </p>
    </section>
    <section>
